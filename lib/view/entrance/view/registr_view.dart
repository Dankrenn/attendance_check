        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              SizedBox(height: 20),
              TextFieldApp(hint: 'Повторите пароль', onChanged: model.setConfirmPassword, isPassword: true, isConfigPassword: true,),
              SizedBox(height: 20),
              Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  ButtonApp(text: "Войти", onChanged: () => model.registerUser(context),),
                  ButtonApp(text: "Авторизироваться", onChanged: () => model.goAuth(context),)
                ],
              ),
            ],
          ),
